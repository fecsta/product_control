...
public class ProdutosAddFragment extends Fragment implements View.OnClickListener {
    private TextView txtProductName, txtDescription, txtPrice;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.produtos_add_fragment, container, false);
    ...
    public void onClick(View v) {
        ...
        {
            case R.id.btnSave:
                ProdutoModel produtoModel = new ProdutoModel(txtProductName.getText().toString(), txtDescription.getText().toString());
                ...
                if(check)
                {
                    ...
                    iProduto.AddNew(produtoModel).enqueue(new Callback<ProdutoModel>() {
                        @Override
